...
// Идентификаторы типов уровней (только 2 типа!)
export type LevelTypeId = 
	| 'olymp'       // Олимпийка (с подтипами 15, 31, 63, 127)
	| 'type100500'  // 100500 секторов и бонусов (без подтипов)

// Категория типа уровня (для совместимости, может быть убрана)
export type LevelCategory = 'olymp' | 'type100500'
 ...
 * 
 * @example
 * Олимпийка: имеет подтипы, фиксированное количество ответов
 * 100500: без подтипов, ручное добавление ответов
 */
export interface LevelTypeConfig {
	// Основные параметры
	id: LevelTypeId         // Только 'olymp' или 'type100500'!
