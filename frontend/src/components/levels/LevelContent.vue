...
import { fieldDefinitions } from '@/entities/level/fields/fieldDefinitions'
import { fieldRenderers, type FieldRenderer } from '@/entities/level/fields/tableRenderers'
import { getLevelTypeConfig } from '@/entities/level/configs'
import type { FieldDefinition, Answer } from '@/entities/level/types'
import {
  buildInitialSelection,
  applyLevelsToAnswer,
  type LevelsSelection
} from '@/composables/levels/useBonusLevelsSelection'
