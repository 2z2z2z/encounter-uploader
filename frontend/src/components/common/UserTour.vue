  ...
  steps.push({
    ...
    description: `
      <div style="text-align: center; padding: 10px;">
        ...
        <p>Страницу загрузки можно обновлять, все данные сохраняются локально и мгновенно обновляются при изменениях.</p>
        <p><em>Этот тур можно пройти повторно в любое время, нажав кнопку "Обучение"</em></p>
      </div>
    `,
    tag: `Мини-обучение`
  })
    ...
    steps.push({
      ...
      description: `
        ...
        <ul style="margin: 10px 0; padding-left: 20px;">
          ...
          <li>Добавление/удаление блоков кнопками + и −</li>
      ...
      afterScript: () => {
        ...
        if (addButton && removeButton) {
          ...
          globalThis.setTimeout(() => {
            ...
            globalThis.setTimeout(() => addButton.classList.remove('tour-demo-pulse'), 800)
          }, 300)

          globalThis.setTimeout(() => {
            removeButton.classList.add('tour-demo-pulse')
            globalThis.setTimeout(() => removeButton.classList.remove('tour-demo-pulse'), 800)
          }, 800)
        }
      }
    })
