...
- ☐ Проверка ESLint и TypeScript-ошибок и исправление для старой архитектуры
- ☐ Проверка и исправление ошибок и проблем из источников Vetur и ts-plugin для старой архитектуры
