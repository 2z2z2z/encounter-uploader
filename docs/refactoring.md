...
- ☐ В колонке "Уровни бонуса" в таблице DataTable кнопка "Выбрать" не работает
...
- ☐ "Бонусное задание" и "Подсказка" не расширяются при фокусе, как это было реализовано в старой архитектуре (проверить, возможно уже исправлено)
