...
- Максимальная простота, минималистичность кода и соответствие DRY;
...
- Взять обертки и все необходимое для UI из LevelUploadLayout для консистентности дизайна
