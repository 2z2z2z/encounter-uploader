...
- Табы для мультитабных типов: до 10 штук, имя 1–20 символов, уникальность не требуется.
...
- Пейлоады для типов уровней с мультитабами: собираются из всех табов, отправляются последовательно.
...
На момент окончания разработки, в новой системе должно существовать **2 типа уровней** (с возможностью легко добавлять новые типа):
