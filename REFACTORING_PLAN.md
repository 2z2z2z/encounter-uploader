...
### **📊 Иерархия типов уровней:**
```
Все типы уровней
├── 🏆 Олимпийки (olymp)
│   ├── Olymp15  ← использует OlympLevelType ← BaseLevelType
│   ├── Olymp31  ← использует OlympLevelType ← BaseLevelType  
│   ├── Olymp63  ← использует OlympLevelType ← BaseLevelType
│   ├── Olymp127 ← использует OlympLevelType ← BaseLevelType
│   └── Будущие олимпийки (5 минут на добавление)
├── 📦 Массовые (bulk)
│   ├── Type100500 ← использует BulkLevelType ← BaseLevelType
│   └── Расширения Type100500
└── 🎨 Кастомные (custom)
    ├── Линейные уровни
    ├── Квесты с выборами  
    └── Любые новые форматы (15-30 минут на добавление)
```
